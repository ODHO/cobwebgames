                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-12">
                                            <div className="row align-items-center">
                                                ...
                                                <div className="col-lg-8 col-md-7 text-end col-7">
                                                    <a href="/portfolio/resource-pack-christmas" className="btn-size btn-green">View
                                                        Assets</a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-12">
                                            <div className="row align-items-center">
                                                ...
                                                <div className="col-lg-8 col-md-7 text-end col-7">
                                                    <a href="/portfolio/resource-pack-valentine" className="btn-size btn-green">View
                                                        Assets</a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-12">
                                            <div className="row align-items-center">
                                                ...
                                                <div className="col-lg-8 col-md-7 text-end col-7">
                                                    <a href="/portfolio/resource-pack-warehouse" className="btn-size btn-green">View
                                                        Assets</a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-12">
                                            <div className="row align-items-center">
                                                ...
                                                <div className="col-lg-8 col-md-7 text-end col-7">
                                                    <a href="/portfolio/resource-pack-construction" className="btn-size btn-green">View
                                                        Assets</a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-12">
                                            <div className="row align-items-center">
                                                ...
                                                <div className="col-lg-8 col-md-7 text-end col-7">
                                                    <a href="/portfolio/resource-pack-shop" className="btn-size btn-green">View Assets</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-12">
                                            <div className="row align-items-center">
                                                ...
                                                <div className="col-lg-8 col-md-7 text-end col-7">
                                                    <a href="/portfolio/resource-pack-dental-clinic" className="btn-size btn-green">View
                                                        Assets</a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-12">
                                            <div className="row align-items-center">
                                                ...
                                                <div className="col-lg-8 col-md-7 text-end col-7">
                                                    <a href="/portfolio/resource-pack-military-base" className="btn-size btn-green">View
                                                        Assets</a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-12">
                                            <div className="row align-items-center">
                                                ...
                                                <div className="col-lg-8 col-md-7 text-end col-7">
                                                    <a href="/portfolio/resource-pack-fantasy-temple" className="btn-size btn-green">View
                                                        Assets</a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-12">
                                            <div className="row align-items-center">
                                                ...
                                                <div className="col-lg-8 col-md-7 text-end col-7">
                                                    <a href="/portfolio/resource-pack-classroom-interior" className="btn-size btn-green">View
                                                        Assets</a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-12">
                                            <div className="row align-items-center">
                                                ...
                                                <div className="col-lg-8 col-md-7 text-end col-7">
                                                    <a href="/portfolio/resource-pack-coffee-shop" className="btn-size btn-green">View
                                                        Assets</a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-12">
                                            <div className="row align-items-center">
                                                ...
                                                <div className="col-lg-8 col-md-7 text-end col-7">
                                                    <a href="/portfolio/resource-pack-viking-village" className="btn-size btn-green">View
                                                        Assets</a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-12">
                                            <div className="row align-items-center">
                                                ...
                                                <div className="col-lg-8 col-md-7 text-end col-7">
                                                    <a href="/portfolio/resource-pack-cyber-city" className="btn-size btn-green">View
                                                        Assets</a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-12">
                                            <div className="row align-items-center">
                                                ...
                                                <div className="col-lg-8 col-md-7 text-end col-7">
                                                    <a href="/portfolio/resource-pack-modern-house-interior."
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-12">
                                            <div className="row align-items-center">
                                                ...
                                                <div className="col-lg-8 col-md-7 text-end col-7">
                                                    <a href="/portfolio/resource-pack-3d-train." className="btn-size btn-green">View
                                                        Assets</a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-12">
                                            <div className="row align-items-center">
                                                ...
                                                <div className="col-lg-8 col-md-7 text-end col-7">
                                                    <a href="/portfolio/resource-pack-3d-car." className="btn-size btn-green">View
                                                        Assets</a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-12">
                                            <div className="row align-items-center">
                                                ...
                                                <div className="col-lg-8 col-md-7 text-end col-7">
                                                    <a href="/portfolio/resource-pack-viking-character." className="btn-size btn-green">View
                                                        Assets</a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-12">
                                            <div className="row align-items-center">
                                                ...
                                                <div className="col-lg-8 col-md-7 text-end col-7">
                                                    <a href="/portfolio/resource-pack-stylize-town" className="btn-size btn-green">View
                                                        Assets</a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-12">
                                            <div className="row align-items-center">
                                                ...
                                                <div className="col-lg-8 col-md-7 text-end col-7">
                                                    <a href="/portfolio/resource-pack-stylize-interior" className="btn-size btn-green">View
                                                        Assets</a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-12">
                                            <div className="row align-items-center">
                                                ...
                                                <div className="col-lg-8 col-md-7 text-end col-7">
                                                    <a href="/portfolio/resource-pack-cyberpunk-characters" className="btn-size btn-green">View
                                                        Assets</a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-12">
                                            <div className="row align-items-center">
                                                ...
                                                <div className="col-lg-8 col-md-7 text-end col-7">
                                                    <a href="/portfolio/resource-pack-winter-office" className="btn-size btn-green">View
                                                        Assets</a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-12">
                                            <div className="row align-items-center">
                                                ...
                                                <div className="col-lg-8 col-md-7 text-end col-7">
                                                    <a href="/portfolio/resource-pack-bus-station" className="btn-size btn-green">View
                                                        Assets</a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-12">
                                            <div className="row align-items-center">
                                                ...
                                                <div className="col-lg-8 col-md-7 text-end col-7">
                                                    <a href="/portfolio/resource-pack-christmas-living-room"
                                                        className="btn-size btn-green">View Assets</a>
                                                </div>
                                            </div>
                                        </div>
